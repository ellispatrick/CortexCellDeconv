...
writeData(wb,  'Figure1c', data.frame(pval = PVAL),rowNames = TRUE,colNames=FALSE) 
...
```{r FigureX_markerCor, fig.height = 7, fig.width = 8}
...
addWorksheet(wb, 'FigureS4a')
writeData(wb,  'FigureS4a', cordf,rowNames = TRUE,colNames=TRUE) 
...
```{r FigureS4b_markersCorDtangleIHC}
...
addWorksheet(wb, 'FigureS9b')
writeData(wb,  'FigureS9b', df,rowNames = TRUE,colNames=TRUE) 
...
addWorksheet(wb, 'FigureS9a')
writeData(wb,  'FigureS9a', df,rowNames = TRUE,colNames=TRUE) 
...
addWorksheet(wb, 'FigureS5')
writeData(wb,  'FigureS5', cordf,rowNames = TRUE,colNames=TRUE) 
...
writeData(wb,  'Figure3b', df,rowNames = TRUE,colNames=TRUE) 
...
writeData(wb,  'Figure3a', cordf,rowNames = TRUE,colNames=TRUE) 
...
addWorksheet(wb, 'FigureS10a')
writeData(wb,  'FigureS10a', DarmanisMean[unlist(markerSub),],rowNames = TRUE,colNames=TRUE) 
...
addWorksheet(wb, 'FigureS10b')
writeData(wb,  'FigureS10b', DarmanisMean[unlist(markerSub),],rowNames = TRUE,colNames=TRUE) 
