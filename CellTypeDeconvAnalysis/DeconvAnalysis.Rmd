...
## Figure 2b - cell-type proportions for different deconvolution algorithms with Darmanis markers

```{r Figure2b_proportionDarmanis, fig.width = 5, fig.height = 5}
...
## Figure 2a - Correlations of cell-type proportions with IHC with Darmanis markers

```{r Figure2a_correlationDarmanis, fig.width = 5, fig.height = 5}
...
## Figure Supp 2b - Zhang proportions


```{r FigureS2b_proportionsZhang,fig.width = 5, fig.height = 5}
...
## Figure Supp 2a - Zhang correlation

```{r FigureS2a_correlationsZhang, fig.width = 5, fig.height = 5}
markerGene = t(geneExpr[c("RBFOX3","GFAP","AIF1","OLIG2","CD34"),])
colnames(markerGene) = c('neuro','astro','microglia','oligo','endo')  
